        ...
        <div className="mx-auto flex max-w-[1400px] flex-col gap-10">
          <div className="flex flex-col justify-between gap-10 md:flex-row md:items-start">
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2.5 font-mono text-[12px] font-semibold uppercase tracking-[0.08em] text-foreground">
                <span
                  aria-hidden
            ...
            <div className="flex flex-col gap-8 sm:flex-row sm:gap-14">
              <nav aria-label="Navegación del sitio" className="flex flex-col gap-3">
                <h2 className="font-mono text-[12px] uppercase tracking-[0.08em] text-zinc-400">
                  Navegación
                </h2>
          ...
          <div className="flex flex-col gap-2 border-t border-white/5 pt-6 font-mono text-[12px] uppercase tracking-[0.08em] text-zinc-400 md:flex-row md:items-center md:justify-between">
            <span>
